...
const cyclerankTab = ref<"s" | "sss">("s");
...
const slidesA = [
  {
    ...
    grid: [
      { img: "/assets/memory/cleopatra1.png", memId: MID.cl },
      { img: "/assets/memory/cleopatra2.png", memId: MID.cl },
      { img: "/assets/memory/cleopatra3.png", memId: MID.cl },
      { img: "/assets/memory/cleopatra1.png", memId: MID.cl },
    ...
    atkLabel: "공격력",
    ultIcon: "/assets/skillball/oblivionult.webp",
    ultLabel: "필살기",
...
const slidesB = [
{
    ...
    grid: [
      ...
      { img: "/assets/memory/gloria3.png", memId: MID.gl },
    ],
    atkIcons: [
      "/assets/memory/memoryatk1.png",
      "/assets/memory/memoryatk2.png",
...
<template>
  ...
  <div class="min-h-screen bg-[#1a1a1a]/95 text-white p-3">
    ...
    <!-- 프로필 이미지 -->
    <HeroMosaic
      leftTop="/assets/portrait/oblivion1.png"
      leftBottom="/assets/portrait/oblivion2.png"
      rightTall="/assets/standings/oblivionS.png"
      rightContainerClass="w-[125px] h-[256px]"
      rightFit="cover"
      rightObjectPosition="50% 0%"
      rightImgClass="scale-[2.2] origin-[52%_30%] translate-y-[25px]"
    />

    <!-- 이름 배지 -->
    <NameBadge text="루나 · 종언" />
    ...
    <Transition name="fade">
      <div v-if="viewMode === 'guide'" class="max-w-4xl w-full mx-auto">
        ...
        <AttrRoleCards
          ...
          :right="{ src: '/assets/roleIcons/ann.webp', label: '인멸형' }"
        />

        <!-- 스킬 박스 -->
        <CharacterSkills char-key="oblivion" />
        ...
        >
          ...
          >
            <WeaponSkills
              weapon-id="circle"
              weapon-img="/assets/arms/circle.png"
              weapon-name="★6 법칙의 재건"
              :skills="weaponSkills"
              weapon-box-class="w-[110px] h-[200px] md:w-[120px] md:h-[220px] overflow-hidden rounded-md border-2 border-orange-500"
              weapon-fit="cover"
              weapon-object-position="51% 15%"
              :weapon-zoom="1.2"
              weapon-transform-origin=""
            />

            <SupportPet
              pet-img="/assets/pets/dragon.webp"
              pet-name="S · 숙악"
              :skills="[
                {
                  img: '/assets/petskills/dragon1.webp',
                  label: '종월의 지시',
                },
                {
                  img: '/assets/petskills/dragon2.webp',
                  label: '어둠의 허공',
                },
                {
                  img: '/assets/petskills/dragon3.webp',
                  label: '불타는 창공',
                },
              ]"
              modal-key="dragon"
