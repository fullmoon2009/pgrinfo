...
const petSkills = [
  { img: "/assets/petskills/cavaliere1.png", label: "악마의 강림" },
  { img: "/assets/petskills/cavaliere2.png", label: "오버톱 기어" },
  { img: "/assets/petskills/cavaliere3.png", label: "톱 기어" },
];
...
const slidesA = [
  {
    ...
    grid: [
      ...
      { img: "/assets/memory/hera3.png" },
      { img: "/assets/memory/hera1.png" },
      { img: "/assets/memory/hers2.png" },
      { img: "/assets/memory/hers3.png" },
    ],
    atkIcons: [
    ...
    ultIcon: "/assets/skillball/danteult.png",
  ...
  },
  {
    ...
    ultIcon: "/assets/skillball/danteult.png",
    tierBadge: { text: "전랭크/공진X", cls: "text-red-500" },
    chipText: "셰익스피어 x4",
    chipText2: "후루루 x2",
    chipText3: "",
  },
...
<template>
  ...
  <div class="min-h-screen bg-[#1a1a1a]/95 text-white p-3">
    <section class="p-3 md:p-6 mx-auto">
      <!-- 상단 3 이미지 -->
      <HeroMosaic
        leftTop="/assets/portrait/dante1.png"
        leftBottom="/assets/portrait/dante2.png"
        rightTall="/assets/standings/danteS.webp"
        rightContainerClass="w-[125px] h-[256px]"
        rightFit="cover"
        rightObjectPosition="30% 15%"
    ...
    >
      ...
      <div class="col-span-2 bg-black/50 rounded-md p-4 text-white space-y-4">
        <WeaponSkills
          weapon-img="/assets/arms/dante.png"
          weapon-name="★6 마검 단테"
          :skills="weaponSkills"
        ...
        <SupportPet
          pet-img="/assets/pets/cavaliere.png"
          pet-name="S · 카발리에"
          :skills="petSkills"
