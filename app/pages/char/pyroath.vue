...
const cyclerankTab = ref<"ss0" | "ss3">("ss0");
...
const allowedRanksByTab = {
  tabA: ["ss0" | "ss3"] as const,
  tabB: ["ss0" | "ss3" | "5slash"] as const,
} as const;
...
watch(cycleTab, (newTab) => {
  ...
  const fallback = newTab === "tabA" ? "ss" : "sss";
...
const slidesA = [
  {
    ...
    grid: [
      { img: "/assets/memory/hera1.png", memId: MID.hr },
      { img: "/assets/memory/hera2.png", memId: MID.hr },
      { img: "/assets/memory/hera3.png", memId: MID.hr },
      { img: "/assets/memory/hera1.png", memId: MID.hr },
      { img: "/assets/memory/adolf2.webp", memId: MID.ad },
      { img: "/assets/memory/adolf3.webp", memId: MID.ad },
    ],
    atkIcons: [
      "/assets/skillball/pyroathbasic.webp"
    ],
    atkLabel: "일반 공격",
    ultIcon: "/assets/skillball/pyroathult.webp",
    ultLabel: "필살기",
  ...
  },
  {
    ...
    grid: [
      ...
      { img: "/assets/memory/adolf2.webp", memId: MID.ad },
      { img: "/assets/memory/adolf3.webp", memId: MID.ad },
      { img: "/assets/memory/wilde1.png", memId: MID.wd },
      { img: "/assets/memory/wilde2.png", memId: MID.wd },
    ],
    atkIcons: [
      "/assets/memory/memoryatk1.png",
      "/assets/skillball/pyroathbasic.webp"
    ],
    atkLabel: "공격력 or 일반 공격",
    ultIcon: "/assets/skillball/pyroathult.webp",
    ultLabel: "필살기",
...
<template>
  ...
  <div class="min-h-screen bg-[#1a1a1a]/95 text-white p-3">
    ...
    <!-- 프로필 이미지 -->
    <HeroMosaic
      leftTop="/assets/portrait/pyroath1.png"
      leftBottom="/assets/portrait/pyroath2.png"
      rightTall="/assets/standings/pyroathS.png"
      rightContainerClass="w-[125px] h-[256px]"
      rightFit="cover"
      rightObjectPosition="75% 0%"
      rightImgClass="scale-[2] origin-[65%_30%] translate-y-[40px]"
    />

    <!-- 이름 배지 -->
    <NameBadge text="루시아 · 서염" />
    ...
    <Transition name="fade">
      <div v-if="viewMode === 'guide'" class="max-w-4xl w-full mx-auto">
        ...
        <!-- 스킬 박스 -->
        <CharacterSkills char-key="pyroath" />
        ...
        >
          ...
          >
            <WeaponSkills
              weapon-id="tachi"
              weapon-img="/assets/arms/tachi.png"
              weapon-name="★6 여명의 불빛"
              :skills="weaponSkills"
              weapon-box-class="w-[110px] h-[200px] md:w-[120px] md:h-[220px] overflow-hidden rounded-md border-2 border-orange-500"
              weapon-fit="cover"
              weapon-object-position="53% 15%"
              :weapon-zoom="1.0"
              weapon-transform-origin=""
            />

            <SupportPet
              pet-img="/assets/pets/raven.webp"
              pet-name="S · 습공"
              :skills="[
                {
                  img: '/assets/petskills/raven1.webp',
                  label: '영광의 빛',
                },
                {
                  img: '/assets/petskills/raven2.webp',
                  label: '타오르는 불꽃',
                },
                {
                  img: '/assets/petskills/raven3.webp',
                  label: '빛나는 날개',
                },
              ]"
              modal-key="raven"
