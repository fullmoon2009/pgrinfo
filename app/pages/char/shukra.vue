...
<template>
  ...
  <div class="min-h-screen bg-[#1a1a1a]/95 text-white p-3">
    ...
    <!-- 프로필 이미지 -->
    <HeroMosaic
      leftTop="/assets/portrait/shukra1.png"
      leftBottom="/assets/portrait/shukra2.png"
      rightTall="/assets/standings/shukraS.png"
    ...
    <Transition name="fade">
      <div v-if="viewMode === 'guide'" class="max-w-4xl w-full mx-auto">
        ...
        <!-- 스킬 박스 -->
        <CharacterSkills char-key="shukra" />
        ...
        >
          ...
          >
            <WeaponSkills
              weapon-id="bipa"
              weapon-img="/assets/arms/sword.png"
              weapon-name="★6 명열궐영"
              :skills="weaponSkills"
              weapon-box-class="w-[110px] h-[200px] md:w-[120px] md:h-[220px] overflow-hidden rounded-md border-2 border-orange-500"
              weapon-fit="cover"
              weapon-object-position="46% 15%"
              :weapon-zoom="1.2"
              weapon-transform-origin=""
            />

            <SupportPet
              pet-img="/assets/pets/peacock.webp"
              pet-name="S · 휘우"
              :skills="[
                {
                  img: '/assets/petskills/peacock1.webp',
                  label: '용의 입진곡',
                },
                {
                  img: '/assets/petskills/peacock2.webp',
                  label: '궁궐의 영혼',
                },
                {
                  img: '/assets/petskills/peacock3.webp',
                  label: '서리의 부리',
                },
              ]"
              modal-key="peacock"
