...
const cyclerankTab = ref<"2ult25" | "2ult15" | "2ult22" | "3ult52" | "3ult421">("2ult25");
...
const allowedRanksByTab = {
  tabA: ["2ult25", "2ult15", "2ult22", "3ult52", "3ult421"] as const,
  tabB: ["2ult25"] as const,
} as const;
...
const slidesA = [
  {
    typeIcon: "/assets/types/dark.png",
    typeBorderCls: "border-2 border-purple-400",
    grid: [
      { img: "/assets/memory/barcelo1.png", memId: MID.ba },
      { img: "/assets/memory/barcelo2.png", memId: MID.ba },
    ...
    atkLabel: "공격력",
    ultIcon: "/assets/skillball/daemonissacore.webp",
    ultLabel: "증폭형",
...
const party1 = {
  ...
  columns: [
    ...
    },
    {
      slides: [
        {
          img: "/assets/portrait/huimu2.png",
          label: "비앙카 · 휘명",
...
<template>
  ...
  <div class="min-h-screen bg-[#1a1a1a]/95 text-white p-3">
    ...
    <!-- 프로필 이미지 -->
    <HeroMosaic
      leftTop="/assets/portrait/daemonissa1.png"
      leftBottom="/assets/portrait/daemonissa2.png"
      rightTall="/assets/standings/daemonissaS.png"
    ...
    <Transition name="fade">
      <div v-if="viewMode === 'guide'" class="max-w-4xl w-full mx-auto">
        ...
        <!-- 스킬 박스 -->
        <CharacterSkills char-key="daemonissa" />
        ...
        >
          ...
          >
            <WeaponSkills
              weapon-id="umbrella"
              weapon-img="/assets/arms/umbrella.webp"
              weapon-name="★6 화려한 밤의 설움"
              :skills="weaponSkills"
            ...
            <SupportPet
              pet-img="/assets/pets/crown.webp"
              pet-name="S · 빌리"
              :skills="[
                {
