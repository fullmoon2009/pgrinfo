...
<template>
  ...
  <div class="min-h-screen bg-[#1a1a1a]/95 text-white p-3">
    ...
    <!-- 프로필 이미지 -->
    <HeroMosaic
      leftTop="/assets/portrait/solacetune1.png"
      leftBottom="/assets/portrait/solacetune2.png"
      rightTall="/assets/standings/solacetuneS.png"
      rightContainerClass="w-[125px] h-[256px]"
      rightFit="cover"
      rightObjectPosition="55% 0%"
      rightImgClass="scale-[2.2] origin-[50%_30%] translate-y-[15px]"
    />

    <!-- 이름 배지 -->
    <NameBadge text="함영 · 단심" />
      ...
      <div v-if="viewMode === 'guide'" class="max-w-4xl w-full mx-auto">
        ...
        >
          ...
          >
            <WeaponSkills
              weapon-id="bipa"
              weapon-img="/assets/arms/bipa.png"
              weapon-name="★6 유영접몽"
              :skills="weaponSkills"
            ...
            <SupportPet
              pet-img="/assets/pets/butterfly.webp"
              pet-name="S · 매오"
              :skills="[
                {
                  img: '/assets/petskills/butterfly1.webp',
                  label: '명월의 추수',
                },
                {
                  img: '/assets/petskills/butterfly2.webp',
                  label: '임강선',
                },
                {
                  img: '/assets/petskills/butterfly3.webp',
                  label: '취화간',
                },
              ]"
              modal-key="butterfly"
