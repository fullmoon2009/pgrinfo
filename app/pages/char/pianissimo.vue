...
const cyclerankTab = ref<"sswx" | "sscx" | "sswo" | "ss3" | "sss">("sswx");
...
const weaponSkills = [
  ...
  { id: "amplight", img: "/assets/wskills/flash.png", label: "초산 플래시" },
...
const slidesA = [
  {
    ...
    grid: [
      { img: "/assets/memory/bur1.png", memId: MID.bu },
      { img: "/assets/memory/bur2.png", memId: MID.bu },
      { img: "/assets/memory/bur3.png", memId: MID.bu },
      { img: "/assets/memory/bur1.png", memId: MID.bu },
    ...
    atkLabel: "공격력",
    ultIcon: "/assets/skillball/pianissimocore.webp",
    ultLabel: "코어 패시브",
  ...
  },
  {
    ...
    grid: [
      { img: "/assets/memory/bur1.png", memId: MID.bu },
      { img: "/assets/memory/bur2.png", memId: MID.bu },
      { img: "/assets/memory/kle3.png", memId: MID.kl },
      { img: "/assets/memory/kle1.png", memId: MID.kl },
      { img: "/assets/memory/kle2.png", memId: MID.kl },
      { img: "/assets/memory/kle3.png", memId: MID.kl },
    ],
    atkIcons: [
      "/assets/memory/memoryatk1.png",
...
const slidesB = [
  {
    ...
    grid: [
      ...
      { img: "/assets/memory/bur3.png", memId: MID.bu },
      { img: "/assets/memory/bur1.png", memId: MID.bu },
      { img: "/assets/memory/patton2.png", memId: MID.pa },
      { img: "/assets/memory/patton3.png", memId: MID.pa },
    ],
    atkLabel: "청색 스킬볼",
    atkIcons: ["/assets/skillball/pianissimoblue.webp"],
    ultLabel: "코어 패시브",
    ultIcon: "/assets/skillball/pianissimocore.webp",
    tierBadge: { text: "SSS 이상", cls: "text-yellow-500" },
    typeName: "물리",
...
<template>
  ...
  <div class="min-h-screen bg-[#1a1a1a]/95 text-white p-3">
    ...
    <!-- 프로필 이미지 -->
    <HeroMosaic
      leftTop="/assets/portrait/pianissimo1.png"
      leftBottom="/assets/portrait/pianissimo2.png"
      rightTall="/assets/standings/pianissimoS.png"
      rightContainerClass="w-[125px] h-[256px]"
      rightFit="cover"
      rightObjectPosition="-15% 40%"
      rightImgClass="scale-[2] origin-[15%_30%] translate-y-[23%]"
    />

    <!-- 이름 배지 -->
    <NameBadge text="세레나 · 희성" />
    ...
    <Transition name="fade">
      <div v-if="viewMode === 'guide'" class="max-w-4xl w-full mx-auto">
        ...
        <!-- 스킬 박스 -->
        <CharacterSkills char-key="pianissimo" />
        ...
        >
          ...
          >
            <WeaponSkills
              weapon-id="orpheus"
              weapon-img="/assets/arms/orpheus.webp"
              weapon-name="★6 오르페우스의 요람"
              :skills="weaponSkills"
            ...
            <SupportPet
              pet-img="/assets/pets/speaker.webp"
              pet-name="S · 설가"
              :skills="[
                {
          ...
          <div class="col-span-2 bg-black/30 rounded-md py-5 px-4 text-white">
            <div
              role="tablist"
